...
def cut_image(img, x_bound_left, x_bound_right, y_bound_up, y_bound_down,):
    """
    Center crop of image with given boundaries
    """
    return img[y_bound_up:img.shape[0]-y_bound_down, x_bound_left:img.shape[1]-x_bound_right]
...
def order_points(pts):
    """
    Rearrange the contour points so that first entry is top-left, second is top-right,  third is bottom-right, fourth is bottom-left. 
    """
...
def automatic_brightness_and_contrast(image, clip_hist_percent=1):
    """
    Brightness and contrast normalization of the image by clipping grays in histogram 
    """
